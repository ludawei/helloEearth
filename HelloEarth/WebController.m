...
//    
//    UIImage *buttonImage = [Util leftNavButtonWithSize:<#(CGSize)#>];
...
//    UIBarButtonItem *left1 = [[UIBarButtonItem alloc] initWithCustomView:button];
    ...
    [leftNavButton addTarget:self action:@selector(clickLeftButton1) forControlEvents:UIControlEventTouchUpInside];
    UIBarButtonItem *left1 = [[UIBarButtonItem alloc] initWithCustomView:leftNavButton];
